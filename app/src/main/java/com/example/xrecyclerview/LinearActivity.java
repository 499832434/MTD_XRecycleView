...
//        mRecyclerView.getDefaultFootView().setLoadingHint("正在加载更多数据...");
//        mRecyclerView.getDefaultFootView().setNoMoreHint("全部数据加载完毕");
...
//                            mAdapter.notifyDataSetChanged();
//                            mRecyclerView.refreshMoreComplete();
//                        }
                    }
        ...
        mAdapter = new MyAdapter(listData,LinearActivity.this);
