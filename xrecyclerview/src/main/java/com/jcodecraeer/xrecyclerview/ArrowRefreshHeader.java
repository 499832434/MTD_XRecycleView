...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	private void initView() {
        ...
        progressView.setIndicatorId(ProgressStyle.BallPulse);
        ...
        drawable = new WindmillDrawable(getContext(), ivWindmill);
	}
	...
	public void setState(int state) {
		...
		if (state == STATE_REFRESHING) {	// 显示进度
            ...
            ivWindmill.setVisibility(View.VISIBLE);
            drawable.start();
            ...
            ivWindmill.setVisibility(View.GONE);
		}
