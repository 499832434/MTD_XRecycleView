...
public class LoadingMoreFooter extends LinearLayout {
    ...
    private String loadingHint="正在加载更多数据...";
    private String noMoreHint="全部数据加载完毕";
    ...
    public void initView(){
        ...
        setLayoutParams(new RecyclerView.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, (int)getResources().getDimension(R.dimen.textHight)));
