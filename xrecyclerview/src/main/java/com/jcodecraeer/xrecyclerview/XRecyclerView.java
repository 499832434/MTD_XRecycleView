...
public class XRecyclerView extends RecyclerView {
    ...
    public void refreshMoreComplete() {
        if(mRefreshHeader != null)
            mRefreshHeader.refreshComplete();
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            Log.e("aaaaa",layoutManager.getItemCount()+"==" +getHeaders_includingRefreshCount());
            Log.e("aaaaa",layoutManager.getChildCount()+"==" +lastVisibleItemPosition+"=="+adjAdapterItemCount+
                    "=="+limitNumberToCallLoadMore+
